...
export const allDeleteDialog = (() => {
  ...
  <div class="c-dialog__header">
      <h1 class="c-dialog__title">すべての絵文字を削除しますか？</h1> <button class="c-button-unstyled c-icon_button c-icon_button--light c-icon_button--size_medium c-dialog__close close" type="button" aria-label="閉じる"> <i class="c-icon c-icon--times" type="times" aria-hidden="true"></i> </button> </div>
      ...
      <div><progress style="display:none" vlaue="0" max="0"></progress></div>
      </div>
